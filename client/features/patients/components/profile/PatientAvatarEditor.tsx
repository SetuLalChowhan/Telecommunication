...
interface PatientAvatarEditorProps {
...
export const PatientAvatarEditor: React.FC<PatientAvatarEditorProps> = ({
  currentImageUrl,
  previewUrl,
  patientName,
  onFileSelect,
    ...
    <div className="panel flex flex-col items-center gap-4 p-4 sm:flex-row">
      <div className="group relative">
        <div className="relative flex h-20 w-20 items-center justify-center overflow-hidden rounded-lg border border-border bg-muted">
          {displayImage ? (
            <Image
              src={displayImage}
              alt={patientName || "Patient Profile"}
              fill
      ...
      <div className="text-center sm:text-left space-y-1">
        ...
        <p className="text-xs text-muted-foreground">
          PNG, JPG or WebP up to 5MB. Visible to your attending specialists during consultations.
        </p>
        {previewUrl && (
